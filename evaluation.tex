...
\begin{table}[htb!]
	...
	\begin{tabular}{M{1.5cm}|M{1.5cm}|M{2cm}|c|M{1.5cm}|M{2cm}|c|M{2cm}|}
		\cline{2-8}
		& \multicolumn{3}{c|}{\textbf{Jorvik (pre Papyrus 3.0)}} & \multicolumn{3}{c|}{\textbf{Jorvik (post Papyrus 3.0)}} & \textbf{Archimate for Papyrus (Pre Papyrus 3.0)}\\ \hline
		...
		\multicolumn{1}{|M{2cm}|}{\textbf{ECore}} & 436 & 0 & 436 & 436 & 0 & 436 & 0 \\ \hline
		...
		\multicolumn{1}{|M{2cm}|}{\textbf{Total}}  & \textbf{436} &\textbf{256} & \textbf{692} & \textbf{436} & \textbf{245} & \textbf{681} & \textbf{4792 (1828)} \\ \hline
		\cline{1-8}
	\end{tabular}

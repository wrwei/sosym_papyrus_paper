...
For brevity, we will not go into details on the content of the polishing transformations for this specific example. \will{need to review the numbers}
...
\begin{table}[t]
	...
	\begin{tabular}{M{2cm}|c|M{2cm}|c|M{2cm}|}
		...
		\multicolumn{1}{|M{2cm}|}{\textbf{File}} & \textbf{Hand-written} & \textbf{Hand-written (Polishing)} & \textbf{Total} & \textbf{Total Hand-written}\\ \hline

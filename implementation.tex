...
\thanos{Any particular reason why the Architecture model doesn't support polishing transformations?}
\will{Architecture model is simple enough, therefore does not need one}

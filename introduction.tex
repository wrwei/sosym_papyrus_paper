...
\begin{enumerate}
	...
	We therefore re-implemented parts of our work to adapt to the changes. \thanos{I believe that 70\% is wrong. If I am not wrong it is just the Arcitecture model and the command class. Right? This is ;ess than 20\% of initial work. We should not refer to percentages in the paper. Just mention the refactoring.}

...
An important advantage of this approach to DSL design is that \sg{it allows the reuse of existing UML tools and it supports widely available UML expertise}.\SG{I see what you are trying to say but this is unclear. Perhaps "while exploiting already available UML expertise?}
...
\SG{Perhaps we can give in a sentence a few details about 3--5?}
\begin{enumerate}

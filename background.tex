...
Furthermore, this option is based on a deprecated framework, and its use is not encouraged. \will{@Thanos, please clarify} \thanos{I believe that the info provided are more than enough. William disagrees as he believe that we should include more technical details. What do you guys think?}
...
\thanos{I believe that the whole discussion about Papyrus 2.0 should be discarded. After reading this, people believe that the contribution of Jorvik is to migrate from 2.0  to 3.0.} In our previous work \cite{zolotas2018towards} based on Papyrus 2.0, we identified a number of models that need to be created, which is shown in Figure~\ref{fig:neededPapyrusFiles}. 

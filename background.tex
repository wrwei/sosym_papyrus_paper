...
Through our experiment (see Section~\ref{sec:evaluation}), we found out that it is almost impossible to create these models without any working examples. \will{mention this in the evaluation}
...
A few hundred lines of code need to be written while tedious Plug-in creation and repetitive model creation tasks should be done. \will{To reference to evaluation} 
